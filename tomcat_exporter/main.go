...
var bindAddr = flag.String("bind-addr", ":9241", "bind address for the metrics server")
...
func main() {
	...
	log.Info("Starting tomcat_exporter")
...
func rootHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`<html>
		<head><title>Tomcat Exporter</title></head>
		<body>
		<h1>Tomcat Exporter</h1>
